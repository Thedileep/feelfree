  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-white text-gray-800 dark:bg-gray-900 dark:text-gray-100">
      ...
      <nav className="flex justify-between items-center py-6 px-8 shadow-md bg-white dark:bg-gray-800 sticky top-0 z-50">
        ...
        <div className="flex space-x-4 text-indigo-600  font-medium">
          <Link to="/about-us" className="hover:underline text-sky-200 ">About Us</Link>
          <Link to="/contact-us" className="hover:underline text-sky-200">Contact Us</Link>
     ...
     {/* FOOTER */}
<footer className="py-8 bg-gray-900 text-center text-sm text-white">
  <div className="flex justify-center space-x-6 font-medium mb-4">
    <Link to="/pricing" className="text-sky-200 hover:underline hover:text-gray-300 transition">
      Pricing
    </Link>
    <Link to="/privacy-policy" className="text-sky-200 hover:underline hover:text-indigo-400 transition">
      Privacy Policy
    </Link>
    <Link to="/terms-conditions" className="text-sky-200 hover:underline hover:text-indigo-400 transition">
      Terms & Conditions
    </Link>
    <Link to="/cancellation-refund" className="text-sky-200 hover:underline hover:text-indigo-400 transition">
      Cancellation & Refund
    </Link>
  </div>
